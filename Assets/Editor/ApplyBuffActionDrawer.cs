...
[CustomPropertyDrawer(typeof(ApplyBuffAction))]
public class ApplyBuffActionDrawer : PropertyDrawer
{
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        height += spacing + EditorGUIUtility.singleLineHeight; // Buff label/button line
